    ...
    <?php foreach($cart_items as $item): ?>
        <div class="cart-item">
            ...
            <div class="cart-controls">
                ...
                <div class="qty-btn" onclick="updateCartItem(<?php echo $item['id']; ?>, <?php echo $item['quantity'] - 1; ?>)">-</div>
                <div class="qty-val" id="qty-val"><?php echo $item['quantity']; ?></div>
                <div class="qty-btn" onclick="updateCartItem(<?php echo $item['id']; ?>, <?php echo $item['quantity'] + 1; ?>)">+</div>
                <div class="delete-btn" onclick="removeCartItem('<?php echo $item['id']; ?>')"><i class="bi bi-trash"></i></div>
            </div>
        </div>
    <?php endforeach; ?>
